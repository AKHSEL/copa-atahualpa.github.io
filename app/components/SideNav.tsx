...
const SideNav = () => {
    return(
        ...
        <a href="#" className='mb-2 flex h-20 items-end justify-start bg-[#1F2BAF] p-4 md:h-40'>
            <div className="w-32 text-white md:w-40">
                <Logo />
            </div>
        </a>
        <div className='flex grown flex-row justify-between space-x-2 md:flex-col md:space-x-0 md:space-y-2'>
             <NavLinks />
